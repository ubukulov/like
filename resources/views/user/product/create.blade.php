...
@section('content')
    ...
    <section class="content">
        <form action="{{ url('user/cert/store') }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row uploadPrice" id="uploadPrice1">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" id="from1" class="form-control int" name="from1" >
                                </div>

                                <div class="col-md-2">
                                    <label for="to1">до</label>
                                    <input type="text" id="to1" class="form-control int" name="to1" >
                                </div>

                                <div class="col-md-4">
                                    <label for="sum1">сумма</label>
                                    <input type="text" id="sum1" class="form-control int" name="sum1" >
                                </div>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="com_agent" name="com_agent" placeholder="Бизнес1" />
                            </div>
