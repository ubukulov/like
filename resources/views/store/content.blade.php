        ...
        <div class="row">
            ...
            <div class="col-md-7" style="padding-left: 30px;">
                ...
                <div class="cert_statistics" style="padding-bottom: 10px;">
                    <font style="color:#d7d7d7"> <i class="fa fa-thumbs-up fa-2"></i></font>&nbsp;&nbsp;Уже купили: 0 чел.<br /><font style="color:#d7d7d7"><i class="fa fa-eye fa-2"></i></font>&nbsp;&nbsp;Заинтересовались: <?= $cert->views ?> чел.
                </div>
                <hr>
