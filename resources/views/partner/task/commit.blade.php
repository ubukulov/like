    ...
    <div class="ui large comments">
        @foreach($commits as $commit)
            ...
            @else
                <div class="comment" style="width: 930px; height: 120px;">
                    <a class="avatar">
                        <img @if(!empty($commit->avatar)) src="{{ asset('uploads/users/small/'.$commit->avatar) }}"  @else src="{{ asset('img/blank_avatar_80.png') }}" @endif style="width: 100px !important; height: 120px;">
                    </a>
                    <div class="content" style="margin-left: 115px !important;">
                        <a class="author">{{ $commit->firstname." ".$commit->lastname }}</a>
                        <div class="metadata">
                            <div class="date">{{ $commit->created }}</div>
                        </div>
                        <div class="text">
        ...
        @endforeach
        <br><br>
        <form class="ui small reply form" method="post" action="{{ url('partner/task/send_commit/'.$work->id) }}">
            {{ csrf_field() }}
            <div class="field">
            ...
            <div class="two fields">
                ...
                <div class="field">
                    <div class="ui small image">
                        ...
                        <br>
                        <button type="button" id="upload1" class="ui small button">Выбрать картинку</button>
                    </div>
                </div>
            </div>
            <button type="submit" class="ui small primary submit labeled icon button" style="width: 250px;"><i class="icon edit"></i> Добавить комментарии</button>
        </form>
    </div>
@stop